...
function CollectClinicals(){
    ...
    //patient info will be displayed to the user at the top of the page
    //patient id will be taken from the previous page
    useEffect(()=>{
    ...
    //when the user enter the form and click the button this method will be invoked
    //int his method data will post to the backend
