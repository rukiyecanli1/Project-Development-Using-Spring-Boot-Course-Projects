...
public class PDFGenerator {
	...
	public void generateItinerary(Reservation reservation, String filePath) {
		...
		//whatever we put into this document, automatically all that will go into 
        //the pdf. 
		Document document = new Document();
		try {
			PdfWriter.getInstance(document, new FileOutputStream(filePath));
			document.open();
			//Here, we add a new table to the pdf. We are going to fill in this 
			//table with all the flight information and passenger details.
